...
public class runner extends AppCompatActivity {
    ...
    public void onClickRecord(View v) {
        ...
        Intent journey = new Intent(runner.this, RecordJourney.class);
        startActivity(journey);
    }

    public void onClickView(View v) {
        // go to the activity for displaying journeys
        Intent view = new Intent(runner.this, ViewJourneys.class);
        startActivity(view);
    }

  /*  public void onClickStatistics(View v) {
        // go to the activity for displaying statistics
        Intent stats = new Intent(runner.this, StatisticsActivity.class);
        startActivity(stats);
    }*/
}
